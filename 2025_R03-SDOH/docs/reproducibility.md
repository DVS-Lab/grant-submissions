...
Expected anchors are N=709, a 91-column analysis master, 216 fixed model specifications, 17/35 runnable historical formulas, and 11 PNG figures. The authoritative public contract is `config/reproduction-contract.json`.
